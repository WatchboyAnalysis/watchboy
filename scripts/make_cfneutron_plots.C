...
// Pretty colors
  ...
  gd_fit->Draw("same");
  TLegend* timingLeg = new TLegend(0.25, 0.67, 0.88, 0.88);
  timingLeg->SetTextSize(0.04);
  ...
  string gd_param = "Target Capture Time: "+(fitss.str()).substr(0, 5)+" #mu S";
  string f1_param = "Uncorrelated Rate: "+(fitss_f1.str()).substr(0, 5)+" hZ";
  string f2_param = "Veto/Target Capture Time: "+(fitss_f2.str()).substr(0, 5)+" #mu S";
